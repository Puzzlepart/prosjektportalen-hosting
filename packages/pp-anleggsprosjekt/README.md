...
3. Seeder hub-listene **Fasesjekkliste Anlegg** (45 sjekkpunkter) og
   **Planneroppgaver Anlegg** (31 oppgaver) via `DataRows`. Som for standardlistene brytes
...
- **Planneroppgaver** – oppgavene fra hub-listen «Planneroppgaver Anlegg» opprettes
  som oppgaver i Planner-planen **«Anleggsoppgaver»** (`plannerTitle`, krever
  Prosjektportalen ≥ 1.14) når listeinnholdet velges ved prosjektoppsett.
- **Standarddokumenter Anlegg** – hub-bibliotek med den fulle 8-hovedmappers

...
|---|---|---|
| `source` | Tekst | Relativ sti til fil under `assets/` |
| `target` | Tekst | Målplassering på hub |
| `description` | Tekst | Beskrivelse av filen |
| `overwrite` | Boolean | `true` = overskriv eksisterende fil, `false` = hopp over hvis filen allerede finnes |
